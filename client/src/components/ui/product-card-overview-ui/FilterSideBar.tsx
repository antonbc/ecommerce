    ...
    for (let i = 1; i <= 5; i++) {
      stars.push(
        <FaStar
          key={i}
          className={
            i <= rating ? "text-yellow-500 text-sm" : "text-gray-400 text-sm"
          }
        />
      );
    }
  ...
  return (
    <div className="border border-gray-700 rounded-lg bg-gray-800 shadow-2xl h-full p-2 w-60 lg:w-72 space-y-4">
      <div className="flex flex-col px-2">
        ...
        <div className="flex gap-2 my-2 bg-gray-700 border border-gray-600 rounded-lg p-2 relative">
          <div>
      ...
      <div className="flex flex-col gap-1 border-t border-t-gray-700 px-2">
        <h4 className="font-semibold text-gray-300 text-xl">Rating</h4>
      ...
      <div className="flex flex-col border-t border-t-gray-700 px-2">
        <h4 className="font-semibold text-gray-300 text-xl">Price</h4>
      ...
      <div className="flex flex-col border-t border-t-gray-700 px-2">
        <h4 className="font-semibold text-gray-300 text-xl">Brand</h4>
